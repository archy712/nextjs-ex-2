...
| **F011** | 존재하지 않는 견적서 안내(404) | Task 005(오류 UI) ✅, Task 010(분기 처리) | 진행중 |
| **F012** | 서비스 장애 안내(503) | Task 005(오류 UI) ✅, Task 010(분기 처리) | 진행중 |
...
| Phase 3: Notion 연동 및 핵심 기능 | 5 | 3 | 진행중 (Task 010 대기) |
| Phase 4: PDF 및 인쇄 품질 | 2 | 0 | 대기 |
| Phase 5: 성능·배포 | 2 | 0 | 대기 |

**다음 작업**: Task 010 — 오류 분기 처리 구현 (F011 / F012)
